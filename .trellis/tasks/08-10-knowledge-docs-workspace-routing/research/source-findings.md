...
- `/knowledge` is the primary workspace overview. The top-level “知识” link opens `/knowledge`, while chapter links use short query aliases such as `/knowledge?section=agents`.
