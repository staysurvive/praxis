...
- Compute shared domain selections in content/practice modules. Compute page-level Knowledge, Journey, and Heatmap
  derived state once in their focused feature view-models, not separately in pages or components.
